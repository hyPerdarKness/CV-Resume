<?php session_start(); if(isset($_SESSION['cvresume'])){ define("include",true); include("../assets/config.php"); $table = htmlclean($_GET['table']); $id = htmlclean($_GET['id']); ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
      ...
      <div class="row">
          <div class="widget">
            <div class="widget-header"><i class="icon-edit"></i>
              <h3><?php echo $table; ?> Düzenle</h3>
            </div>
            <div class="widget-content">
<?php 

switch ($table){
   case "Deneyim": include("plug/edit1.php"); break;
   case "Proje": include("plug/edit2.php"); break;
   case "Program": include("plug/edit3.php"); break;
   case "Eğitim": include("plug/edit4.php"); break;
   case "Dil": include("plug/edit5.php"); break;
   case "Hobi/Yetenek": include("plug/edit6.php"); break;
